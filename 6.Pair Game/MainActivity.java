...
public class MainActivity extends AppCompatActivity {
    ...
    private int[] cards = {
            ...
            R.drawable.cat1, R.drawable.cat1, R.drawable.cat2, R.drawable.cat2,
    };

    private ImageButton prevButton;
    private int visibleCardCarount;
    ...
    public void onBtnCard(View view) {
        ...
        if(card == prevCard){
            ...
            prevButton = null;
            visibleCardCarount -= 2;
            if(visibleCardCarount == 0){
                askRestart();
            }
            return;
        }
    ...
    private void startGame() {
        ...
        prevButton = null;
        visibleCardCarount = cards.length;
